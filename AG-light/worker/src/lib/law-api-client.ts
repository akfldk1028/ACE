/**
 * 법제처 API 클라이언트
 * 원본: korean-law-mcp/src/lib/api-client.ts
 * Workers 적응: session-state/process.env 제거, 생성자에서 apiKey 직접 전달
 */
...
export class LawApiClient {
  ...
  /** Workers에서는 생성자 apiKey 또는 override만 사용 */
