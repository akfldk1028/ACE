...
Provides access to Auto-Claude's system prompts from the submodule.
"""
...
PROMPTS_DIR = Path(__file__).parent.parent.parent / "modules" / "Auto-Claude" / "apps" / "backend" / "prompts"
