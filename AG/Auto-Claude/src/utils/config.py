"""
Configuration management for AG/Auto-Claude CLI
...
class Settings(BaseSettings):
    ...
    # Auto-Claude Connection (relative to project root)
    auto_claude_path: str = str(Path(__file__).parent.parent.parent / "apps" / "backend")
