...
// GitLab integration
  ...
  AUTOGEN_BIND_SESSION: 'autogen:bindSession',           // Bind AutoGen session to current project
  AUTOGEN_UNBIND_SESSION: 'autogen:unbindSession',       // Unbind AutoGen session from project
  AUTOGEN_GET_UNBOUND_SESSIONS: 'autogen:getUnboundSessions',  // Get sessions not bound to any project
