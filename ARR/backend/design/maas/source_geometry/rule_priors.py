...
ARCHITECTURAL_RULE_PRIORS: dict[str, dict[str, Any]] = {
    ...
    "array_cluster": _rule(
        ...
        optional_inputs=("lower_floor_fraction",),
        prior_defaults={"upper_ratio": 0.82, "count": 2.0, "unit": 0.46, "spacing": 0.26},
        bounds={"count": (2.0, 3.0), "unit": (0.36, 0.58), "spacing": (0.18, 0.38)},
        height_band_profile={"lower_split": 0.36, "alternating_band": 0.75, "cap_band": 1.0},
        geometry_actions=("instantiate_repeated_cells", "alternate_offsets", "vary_cell_height_bands"),
        rationale="Array cluster massing uses a common podium datum with two or three substantial program boxes, not scattered miniature cells.",
    ),
    "offset": _rule(
        "offset",
