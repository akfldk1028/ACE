...
class PatternEventType(str, Enum):
    """Types of pattern events (inline - originally from src.watcher.pattern_watcher)"""
    CREATED = "created"
    MODIFIED = "modified"
    DELETED = "deleted"
...
@dataclass
class PatternEvent:
    """Event representing a pattern file change (inline - originally from src.watcher.pattern_watcher)"""
