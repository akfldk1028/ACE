# CLAUDE.md - AI Agent Context File (MassAgent & 25_ACE)
...
10. **크로스 AI(Codex, Claude, Gemini) 공통 동기화 원칙**: CLAUDE.md, GEMINI.md에 정의된 대지 안착/Envelope 수식을 단일 진실 원천으로 공유하며, 3대 핵심 테스트(종합법규, 대지별 Envelope, 사이트 클릭 중첩규제) 100% 통과 유지.
