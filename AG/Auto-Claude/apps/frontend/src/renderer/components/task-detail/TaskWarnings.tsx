import { AlertTriangle, Play, RotateCcw, Loader2, X } from 'lucide-react';
              ...
              >
                {isRecovering ? (
                  ...
                  <>
                    ...
                    {t('tasks:warnings.recoverAndRestart')}
                  </>
                )}
              </Button>
            </div>
        ...
        <div className="rounded-xl border border-orange-500/30 bg-orange-500/10 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              {onDismiss && (
                <Button variant="outline" size="sm" onClick={onDismiss} className="w-full mt-2">
                  <X className="mr-2 h-4 w-4" />
                  {t('tasks:warnings.dismiss')}
                </Button>
              )}
            </div>
          </div>
