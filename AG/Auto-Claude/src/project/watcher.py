"""
Project folder watcher for AG/Auto-Claude
...
class ProjectFileHandler(FileSystemEventHandler):
    ...
    def on_created(self, event: FileCreatedEvent) -> None:
        ...
        # Path traversal defense: ensure file is inside the watched queue directory
        queue_dir = (self.projects_dir / "queue").resolve()
        try:
            file_path.relative_to(queue_dir)
        except ValueError:
            self.logger.warning("path_traversal_blocked", file=str(file_path))
            return
